export const routes = {
  ...
  merchantRiderCall: "/api/v1/merchant/orders/{order_id}/rider-calls",
  ...
  riderIncident: "/api/v1/rider/incidents",
  riderEarnings: "/api/v1/rider/earnings",
  ...
  customerReportStatus: "/api/v1/customer/orders/{order_id}/exterior-reports/status",
  customerNotificationPreferences: "/api/v1/customer/notification-preferences",
  branchDashboard: "/api/v1/control/branches/{branch_id}/dashboard",
  branchReadiness: "/api/v1/control/branches/{branch_id}/readiness",
  branchIncidents: "/api/v1/control/branches/{branch_id}/incidents",
  branchCommand: "/api/v1/control/commands",
  branchCommandApproval: "/api/v1/control/commands/{command_id}/approvals",
  branchSettlementApproval: "/api/v1/control/settlements/{settlement_id}/approvals",
  branchPilotChecklist: "/api/v1/control/branches/{branch_id}/pilot-checklist",
  branchSandboxReports: "/api/v1/control/branches/{branch_id}/sandbox-reports",
} as const;
