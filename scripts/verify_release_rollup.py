...
def main() -> int:
    ...
    expected_prs = [*range(1, 64), 72, 73, 75, 76]
    if manifest["included_pull_requests"] != expected_prs:
        failures.append("included PRs must be 1..63 plus feature PRs 72, 73, 75 and 76")
    if manifest["version"] != "0.1.0-rc.9" or manifest["purpose"] != "REVIEW_ONLY":
    ...
    required_internal = {
        ...
        "map_knowledge_contract",        "mobile_navigation_synthetic_matrix",
        "route_choice_safety_cost",
        "arkaon_map_competency",
    }
    ...
    artifact_hashes = {
        ...
        "map_knowledge_contract": "src/narang_rider/map_integration.py",        "mobile_navigation_synthetic_matrix": "src/narang_rider/mobile_navigation.py",
